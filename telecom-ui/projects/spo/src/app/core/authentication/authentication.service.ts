...
export class AuthenticationService {
  ...
  createCredentials(tokenInfo: TokenInfo, jwt: Jwt): void {
    ...
    const isAdmin = includes(groups, this.adminGroup) || includes(groups, this.spoAdminGroup);
  ...
  private isAdmin(): boolean {
    return includes(this.credentials.groups, this.adminGroup) || includes(this.credentials.groups, this.spoAdminGroup);
  }
}
