...
export class AuthenticationService {
   ...
   * The admin group
   */
  private tempoAdminGroup: string = environment.tempoAdminGroup;
  ...
  isBelongGroup(): boolean {
    return this.isUser() || this.isRsm() || this.isAdmin();
  }
  ...
  createCredentials(tokenInfo: TokenInfo, jwt: Jwt): void {
    ...
    const isAdmin = includes(groups, this.adminGroup) || includes(groups, this.tempoAdminGroup);
  ...
  private isAdmin(): boolean {
    return (
      includes(this.credentials.groups, this.adminGroup) || includes(this.credentials.groups, this.tempoAdminGroup)
    );
  }
}
